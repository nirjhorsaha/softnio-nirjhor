...
function App() {
    ...
    return (
        <div className="mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-[60px] w-full lg:w-[1320px] h-auto lg:h-[720px] justify-center items-center ">
                <img
                    src={getImage()}
                    alt="image"
                    className="lg:h-[720px] w-full lg:w-[630px] mx-auto object-cover rounded-[4px]"

                />
                <div className="w-full lg:w-[630px] h-auto lg:h-[539px] text-left mx-auto ">
                    <h2 className="h-[68px] text-[32px] md:text-[38px] lg:text-[44px] font-[700] leading-[44px] tracking-[-1.2px] text-[#364A63] py-3">
                        Classy Modern Smart Watch
                    </h2>
                    <div className="flex items-center gap-2 h-[28px] mt-6 md:mt-0">
                    ...
                    <div className="flex gap-[43px] pt-16 md:pt-5 pr-1 h-[67px]">
                        <div>
                    ...
                    <div className="h-[74px] mt-14 md:mt-0">
                        ...
                        <div className="h-[86px]">
                            ...
                            <div className="flex gap-3 pt-[20px] h-[56px] items-center ">
                                ...
                                <button onClick={handleAddToCart}
                                    ...
                                    className="bg-[#6576FF]  px-[18px] py-[8px] rounded-[3px] flex items-center justify-center">
            ...
            <div className="pt-36 lg:pt-[112px] mx-auto w-full lg:w-[1320px]">
            ...
            {showModal && (
                <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
                    {/* <div className="bg-white p-[44px] rounded-[20px] w-[651px] h-[480px] space-y-4 overflow-y-auto"> */}
                    <div className="bg-white p-6 md:p-[44px] rounded-[20px] w-[90%] lg:w-[651px] h-auto md:h-[480px] overflow-y-auto space-y-4">
                        <h2 className="text-[#364A63] text-left font-bold text-[22px] leading-[24px]">Your Cart</h2>
                        <div className="grid grid-cols-[278px_1fr_1fr_1fr_1fr] gap-4 md:border-b  border-[#DBDFEA] h-[36px] pt-1 pr-1 pb-2">
                        ...
                        <div className="space-y-4">
                            {/* First Item */}
                            <div className="grid grid-cols-[278px_1fr_1fr_1fr_1fr] gap-4 md:border-b border-[#DBDFEA] pb-4 pr-1 ">
                            ...
                            <div className="grid grid-cols-[278px_1fr_1fr_1fr_1fr] gap-4 md:border-b border-[#DBDFEA] pb-4 pr-1 ">
                                ...
                                <div className="text-[#364A63] font-normal text-[14px] leading-[23.1px] my-auto">Cyan</div>
                                <div className="text-[#364A63] font-bold text-[14px] leading-[23.1px] my-auto">L</div>
                                <div className="text-[#364A63] font-bold text-[14px] leading-[23.1px] my-auto">1 </div>
                                <div className="text-[#364A63] font-bold text-[14px] leading-[23.1px] my-auto text-right">$99.00</div>
                            </div>

                            {/* total count */}
                            <div className="grid grid-cols-[278px_1fr_1fr_1fr_1fr] pr-1 gap-4">
                                <div className="text-[#373737] font-bold text-[16px] leading-[22px] -tracking-[0.2] text-left my-auto ">Total</div>
                                <div className="text-[#364A63] font-bold text-[14px] leading-[23.1px] my-auto"></div>
                                <div className="text-[#364A63] font-bold text-[14px] leading-[23.1px] my-auto"></div>
